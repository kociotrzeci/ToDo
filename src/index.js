...
notebook.addNote('title1', 'desc', '2024-10-20', '2', 0);
notebook.addNote('title2', 'desc', '2024-10-20', '2', 0);
notebook.addNote('title3', 'desc', '2024-10-20', '1', 0);
notebook.addNote('title4', 'desc', '2024-10-20', '0', 0);
notebook.addNote('title5', 'desc', '2024-10-20', '0', 0);
notebook.addNote('title6', 'desc', '2024-10-20', '1', 0);
notebook.addNote('title2', 'desc', '2024-10-20', '1', 0);
notebook.addNote('title3', 'desc', '2024-10-20', '2', 1);
notebook.addNote('title4', 'desc', '2024-10-20', '1', 1);
notebook.addNote('title5', 'desc', '2024-10-20', '0', 1);
